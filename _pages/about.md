...
I currently work as an Operations Systems Specialist at [FISPAN](https://fispan.com), a financial services company that has partnered with 16 of the top banks in North America (including J.P. Morgan Chase) with combined assets exceeding $3T. I design, build, and maintain secure, scalable automation systems that support customer and revenue operations in a regulated fintech environment. My work focuses on administering and configuring the core systems used by the Operations department, analyzing and designing business processes, building and maintaining automation architecture, and ensuring data integrity and reliability across interconnected platforms.

My academic and professional path has covered a wide range of industries and technologies, and I've built up a diverse skill set because of it. Those skills span business process automation and workflow creation, software administration, project management, content creation, and practical use of AI tools for multimodal and agentic workflows. I specialize in low/no-code automation platforms like Make.com and n8n, where I design production-grade workflows that orchestrate data across multiple systems with an emphasis on security, reliability, and maintainability. Most recently, I completed a company-wide migration from Make to n8n in approximately six weeks, rebuilding nearly every automation while improving long-term scalability.

I also spend a lot of my free time learning to program. In early 2024, I worked through [Harvard's CS50: Introduction to Computer Science](https://pll.harvard.edu/course/cs50-introduction-computer-science), solving problems across a range of languages including C, Python, SQL, HTML/CSS, and JavaScript. I took those principles and applied them in my own work, some of which can be found in the [Projects](https://ddugan23.github.io/projects/) tab.

My academic background includes a B.A. in Economics and an A.A. in Film Production, which together shaped my structured, systems-oriented approach to operational work.

Outside of work, I run, hike, read, and play chess. I'm currently learning Go (Weiqi, Baduk) and Mandarin!
